...
10. HARDENING
------------------------------------------------------------------------
  - metadata: {'defense_name': 'spatial_smoothing', 'defense_type': 'preprocessing', 'parameters': {'kernel_size': 3, 'sigma': 1.0}, 'execution_time_seconds': 3.981590270996094e-05, 'timestamp': '2026-09-21 16:53:10', 'extra_metadata': {'defense_family': 'preprocessing'}}
  - success: True
  - status: insufficient
