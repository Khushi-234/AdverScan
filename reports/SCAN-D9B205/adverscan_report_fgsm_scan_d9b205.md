...
========================================================================
  Report ID   : RPT-BE9BAECB
  Scan ID     : SCAN-D9B205
  Timestamp   : 2026-09-19 15:37:22
  Risk Level  : LOW
  Vuln. Score : 16.98
========================================================================
...
|---|---|---|---|---|---|---|
| FGSM          | Default    | 0.34s     | 90.00%       | 70.00%  | 20.00%   | **22.22%** |
...
10. HARDENING
------------------------------------------------------------------------
  - metadata: {'defense_name': 'spatial_smoothing', 'defense_type': 'preprocessing', 'parameters': {'kernel_size': 3, 'sigma': 1.0}, 'execution_time_seconds': 0.008884668350219727, 'timestamp': '2026-09-19 15:37:22', 'extra_metadata': {'defense_family': 'preprocessing'}}
  - success: True
  - metrics_before: {}
  - metrics_after: {}
  - recommendations: ['Applied Gaussian Filter defense (kernel_size=3, sigma=1.00).', "Selector Context: Selected 'model_ensemble' (score: 386.4) based on context: risk=LOW, attack=fgsm (iterative=False), domain=image, latency_sensitive=False, retraining_allowed=True."]
...
------------------------------------------------------------------------
  ...
  Started At   : 2026-09-19 15:37:21
  Total Time   : 0.00s
  Overall      : SUCCESS
...
========================================================================
  Generated by AdverScan — 2026-09-19 15:37:22
========================================================================